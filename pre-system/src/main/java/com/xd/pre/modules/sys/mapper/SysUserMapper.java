...
public interface SysUserMapper extends BaseMapper<SysUser> {
    ...
    @Insert("insert into sys_user (username,password,dept_id,job_id,team_id,phone,email,avatar,lock_flag) values (#{username},#{password},#{deptId},#{jobId},#{teamId},#{phone},#{email},#{avatar},#{lockFlag})")
