package com.xd.pre.generator.mapper;
...
public interface SysCodeMapper {
     ...
     * @return
     */
    @Select("select COLUMN_NAME AS columnName,DATA_TYPE AS dataType,COLUMN_COMMENT AS columnComment,CHARACTER_SET_NAME AS characterSetName,COLUMN_TYPE AS columnType from information_schema.COLUMNS where table_name = #{arg0} and table_schema = #{arg1}")
